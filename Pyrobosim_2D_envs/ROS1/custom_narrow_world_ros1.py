...
def create_narrow_world():
    ...
    top_wall_points = [
        ...
        (2.5, 4.0),      # Starts angling inwards
        (3.0, 3.5),      # Narrows more
        (3.5, 3.35),     # Narrows to passage
        (4.0, 3.5),      # NARROW PASSAGE (1 meter width)
        (5.0, 3.5),      # Narrow passage continues
        (6.0, 3.5),      # Narrow passage continues
        (7.0, 3.5),      # Narrow passage continues
        (8.0, 3.5),      # Narrow passage continues
        (9.0, 3.5),      # Narrow passage continues
        (10.0, 3.5),     # Narrow passage continues
        (10.5, 3.35),    # Starts widening
        (11.0, 3.5),     # Widens more
        (11.5, 4.0),     # Widens towards exit
        (12.0, 4.5),     # Far right exit - WIDE
        (15.0, 4.5),     # Far right exit - WIDE
    ]
    ...
    bottom_wall_points = [
        ...
        (2.8, 2.0),      # After dark block
        (3.0, 2),      # Narrows more
        (3.5, 2),     # Narrows to passage
        (4.0, 2),      # NARROW PASSAGE (1 meter width - bottom at 2.5)
        (5.0, 2),      # Narrow passage continues
        (6.0, 2),      # Narrow passage continues
        (7.0, 2),      # Narrow passage continues
        (8.0, 2),      # Narrow passage continues
        (9.0, 2),      # Narrow passage continues
        (10.0, 2),     # Narrow passage continues
        (10.5, 2.0),    # Starts widening
        (11.0, 2.0),     # Widens more
        (11.5, 2.0),     # Widens towards exit
        (12.0, 1.5),     # Far right exit - WIDE
        (15.0, 1.5),     # Far right exit - WIDE
    ]
...
def visualize_world_with_grid(world, agents):
    ...
    bottom_wall_polygon = Polygon([
        ...
        (10.5, 2.6), (11.0, 2.3), (11.5, 2.0), (12.0, 1.5), (15.0, 1.5), (15.0, 0.0), (0.0, 0.0)  # Bottom of screen
    ])
